...
model_state_dict = torch.load('./Models/clinical_2_39_categories.dat')
...
#Gastroenterology'], self.df.loc[index, 'Neurology'], self.df.loc[index, 'Orthopedic'],             self.df.loc[index, 'Radiology'],self.df.loc[index, 'Urology
    ...
    if (params != None):
        ...
        for sen in params['data']:
            tokens_ids,attn_mask = tokinize(sen['text'])
            with torch.no_grad():
            ...
            answer.append({"id":sen['id'], "classes": {' Allergy / Immunology':str(result_list[0]),' Autopsy':str(result_list[1]),' Bariatrics':str(result_list[2]),' Cardiovascular / Pulmonary':str(result_list[3]),' Chiropractic':str(result_list[4]),' Consult - History and Phy.':str(result_list[5]),' Cosmetic / Plastic Surgery':str(result_list[6]),' Denti:stry':str(result_list[7]),' Dermatology':str(result_list[8]),' Diets and Nutritions':str(result_list[9]),' Discharge Summary':str(result_list[10]),' ENT - Otolaryngology':str(result_list[11]),' Emergency Room Reports':str(result_list[12]),' Endocrinology':str(result_list[13]),' Ga:stroenterology':str(result_list[14]),' General Medicine':str(result_list[15]),' Hematology - Oncology':str(result_list[16]),' Hospice - Palliative Care':str(result_list[17]),' Lab Medicine - Pathology':str(result_list[18]),' Letters':str(result_list[19]),' Nephrology':str(result_list[20]),' Neurology':str(result_list[21]),' Neurosurgery':str(result_list[22]),' Obstetrics / Gynecology':str(result_list[23]),' Office Notes':str(result_list[24]),' Ophthalmology':str(result_list[25]),' Orthopedic':str(result_list[26]),' Pain Management':str(result_list[27]),' Pediatrics - Neonatal':str(result_list[28]),' Physical Medicine - Rehab':str(result_list[29]),' Podiatry':str(result_list[30]),' Psychiatry / Psychology':str(result_list[31]),' Radiology':str(result_list[32]),' Rheumatology':str(result_list[33]),' SOAP / Chart / Progress Notes':str(result_list[34]),' Sleep Medicine':str(result_list[35]),' Speech - Language':str(result_list[36]),' Surgery':str(result_list[37]),' Urology':str(result_list[38])} })
        print(logits)

        # toxique	toxique_severe	  obscene	menace   	insulte   	haine_raciale
        result = {' Allergy / Immunology':str(result_list[0]),' Autopsy':str(result_list[1]),' Bariatrics':str(result_list[2]),' Cardiovascular / Pulmonary':str(result_list[3]),' Chiropractic':str(result_list[4]),' Consult - History and Phy.':str(result_list[5]),' Cosmetic / Plastic Surgery':str(result_list[6]),' Denti:stry':str(result_list[7]),' Dermatology':str(result_list[8]),' Diets and Nutritions':str(result_list[9]),' Discharge Summary':str(result_list[10]),' ENT - Otolaryngology':str(result_list[11]),' Emergency Room Reports':str(result_list[12]),' Endocrinology':str(result_list[13]),' Ga:stroenterology':str(result_list[14]),' General Medicine':str(result_list[15]),' Hematology - Oncology':str(result_list[16]),' Hospice - Palliative Care':str(result_list[17]),' Lab Medicine - Pathology':str(result_list[18]),' Letters':str(result_list[19]),' Nephrology':str(result_list[20]),' Neurology':str(result_list[21]),' Neurosurgery':str(result_list[22]),' Obstetrics / Gynecology':str(result_list[23]),' Office Notes':str(result_list[24]),' Ophthalmology':str(result_list[25]),' Orthopedic':str(result_list[26]),' Pain Management':str(result_list[27]),' Pediatrics - Neonatal':str(result_list[28]),' Physical Medicine - Rehab':str(result_list[29]),' Podiatry':str(result_list[30]),' Psychiatry / Psychology':str(result_list[31]),' Radiology':str(result_list[32]),' Rheumatology':str(result_list[33]),' SOAP / Chart / Progress Notes':str(result_list[34]),' Sleep Medicine':str(result_list[35]),' Speech - Language':str(result_list[36]),' Surgery':str(result_list[37]),' Urology':str(result_list[38])}
...
def predict2():
        ...
        sentence = ["This is an aspirin"]
        print(sentence)
        answer = []
        for sen in sentence:
            tokens_ids,attn_mask = tokinize(sen)
            with torch.no_grad():
                logits = net(torch.tensor(tokens_ids).unsqueeze(0), torch.tensor(attn_mask).unsqueeze(0))
                m = nn.Softmax(dim=1)
                result_list = torch.tensor(m(logits[0])).cpu().numpy()
                result_list = result_list.flatten()
            answer.append({"id":1, "classes": {' Allergy / Immunology':str(result_list[0]),' Autopsy':str(result_list[1]),' Bariatrics':str(result_list[2]),' Cardiovascular / Pulmonary':str(result_list[3]),' Chiropractic':str(result_list[4]),' Consult - History and Phy.':str(result_list[5]),' Cosmetic / Plastic Surgery':str(result_list[6]),' Denti:stry':str(result_list[7]),' Dermatology':str(result_list[8]),' Diets and Nutritions':str(result_list[9]),' Discharge Summary':str(result_list[10]),' ENT - Otolaryngology':str(result_list[11]),' Emergency Room Reports':str(result_list[12]),' Endocrinology':str(result_list[13]),' Ga:stroenterology':str(result_list[14]),' General Medicine':str(result_list[15]),' Hematology - Oncology':str(result_list[16]),' Hospice - Palliative Care':str(result_list[17]),' Lab Medicine - Pathology':str(result_list[18]),' Letters':str(result_list[19]),' Nephrology':str(result_list[20]),' Neurology':str(result_list[21]),' Neurosurgery':str(result_list[22]),' Obstetrics / Gynecology':str(result_list[23]),' Office Notes':str(result_list[24]),' Ophthalmology':str(result_list[25]),' Orthopedic':str(result_list[26]),' Pain Management':str(result_list[27]),' Pediatrics - Neonatal':str(result_list[28]),' Physical Medicine - Rehab':str(result_list[29]),' Podiatry':str(result_list[30]),' Psychiatry / Psychology':str(result_list[31]),' Radiology':str(result_list[32]),' Rheumatology':str(result_list[33]),' SOAP / Chart / Progress Notes':str(result_list[34]),' Sleep Medicine':str(result_list[35]),' Speech - Language':str(result_list[36]),' Surgery':str(result_list[37]),' Urology':str(result_list[38])} })
        print(logits)
